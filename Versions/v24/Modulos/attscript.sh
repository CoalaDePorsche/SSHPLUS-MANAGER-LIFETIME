...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/CoalaDePorsche/SSHPLUS-MANAGER-LIFETIME/master/Versions/v24/Install/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/CoalaDePorsche/SSHPLUS-MANAGER-LIFETIME/master/Versions/v24/Plus > /dev/null 2>&1
